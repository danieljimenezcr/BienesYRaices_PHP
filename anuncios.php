    ...
    <main class="contenedor seccion">
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    <h3>Casa de Moderna de Ladrillo</h3>
                    <p>Casa con diseño moderno, asi como con tecnología inteligente y amueblada</p>
                    <p class="precio">$2,000,000</p>
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    <h3>Casa con vista al mar</h3>
                    <p>Casa con vista al mar y acabados de lujo en la la costa, excelente oportunidad</p>
                    <p class="precio">$3,000,000</p>
